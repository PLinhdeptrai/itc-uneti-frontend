  ...
  return (
      <div>
        ...
        <div className='containerCour'>
              ...
              <Carousel indicators={false} nextIcon={false} prevIcon={false} className='slideCour' interval={1500}>
              <Carousel.Item>
                <img
                ...
                {demoItem.map((item) => (
                  <div key={item.id} className='bodyItem'>
                    ...
                    <Button className='btn-singin' variant="warning" onClick={() => {setModalOpen(true)}}>Đăng kí ngay</Button>{' '}
